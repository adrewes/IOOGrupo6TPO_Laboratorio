...
public class PeticionController {
	...
	public ArrayList<PeticionDTO> getPeticionListPorPaciente(PacienteDTO pacienteDTO)
	{
		ArrayList<PeticionDTO> lista = new ArrayList<PeticionDTO>();
		for (Peticion peticion: datosPeticiones){
			if (peticion.getPacienteID().equals(pacienteDTO.getPacienteID())){
	...
	public ArrayList<PeticionDTO> getPeticionListPorSucursal(SucursalDTO sucursalDTO)
	{
		ArrayList<PeticionDTO> lista = new ArrayList<PeticionDTO>();
		for (Peticion peticion: datosPeticiones){
			if (Integer.parseInt(peticion.getSucursalID()) == sucursalDTO.getNumero()){
				lista.add(peticion.toDTO());				
			}
		}
		return lista;
